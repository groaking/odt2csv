...
parser = argparse.ArgumentParser(
    prog='odt2csv',
    description='Converts an ODT file generated by OOMMF into a CSV-formatted file',
    epilog='Created by Samarthya Lykamanuella on 2023-07-08'
)
parser.add_argument('-i', '--input', help='The input ODT file to convert to CSV', nargs=1)
parser.add_argument('-o', '--output', help='The output CSV file', nargs=1)
